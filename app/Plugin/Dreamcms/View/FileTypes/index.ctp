...
<?php foreach ($fileTypes as $fileType): ?>
													<tr>
														...
														<td class="hidden-480"><?php echo h($fileType['FileType']['published']); ?>&nbsp;</td>
														<td class="hidden-480"><?php echo h($fileType['FileType']['created']); ?>&nbsp;</td>
														<td class="hidden-480"><?php echo h($fileType['FileType']['modified']); ?>&nbsp;</td>
														<td class="center">
															<?php if (isset($current_acl['read']) && $current_acl['read']) echo $this->Html->link($this->Html->tag('i', ' ' . __('View'), array('class' => 'icon-eye-open bigger-120')), array('action' => 'view', $fileType['FileType']['id']), array('class' => 'btn btn-xs btn-warning dt-btns', 'escape' => false)); ?> &nbsp; 
															<?php if (isset($current_acl['update']) && $current_acl['update']) echo $this->Html->link($this->Html->tag('i', ' ' . __('Edit'), array('class' => 'icon-edit bigger-120')), array('action' => 'edit', $fileType['FileType']['id']), array('class' => 'btn btn-xs btn-info dt-btns', 'escape' => false)); ?> &nbsp; 
															<?php if (isset($current_acl['delete']) && $current_acl['delete']) echo $this->Form->postLink($this->Html->tag('i', ' ' . __('Delete'), array('class' => 'icon-trash bigger-120')), array('action' => 'delete', $fileType['FileType']['id']), array('class' => 'btn btn-xs btn-danger dt-btns', 'escape' => false), __('Are you sure you want to delete # %s?', $fileType['FileType']['id'])); ?> &nbsp; 
														</td>
													</tr>
<?php endforeach; ?>
