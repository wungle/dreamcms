			...
			<?php echo $this->Form->create('Page', array('role' => 'form')); ?> 
				<fieldset>
					...
					<div class="form-group">
						...
						<div>
							<?php echo $this->Form->input('published_at', array('type' => 'datetime', 'dateFormat' => 'DMY', 'timeFormat' => '24', 'selected' => date('Y-M-D') . ' 00:00:00', 'label' => false)); ?> 
						</div>
					</div><!-- .form-group -->
				...
				<div id="PageAttachments">
					...
					<div id="PageAttachmentsContainer"></div>
				</div>
