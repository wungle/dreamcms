 ...
 * PageType Model
 *
 * @property PageType $ParentPageType
 * @property PageType $ChildPageType
 * @property Page $Page
 */
 ...
 */
	public $hasMany = array(
		'ChildPageType' => array(
			...
			'foreignKey' => 'parent_id',
			'dependent' => false,
			'conditions' => array('ChildPageType.deleted' => '0'),
			'fields' => '',
			'order' => '',
			'limit' => '',
			'offset' => '',
		...
		'Page' => array(
			...
			'dependent' => false,
			'conditions' => array('Page.deleted' => '0'),
			'fields' => '',
			'order' => '',
			'limit' => '',
			'offset' => '',
