 ...
 */
	public $validate = array(
		...
		'width' => array(
			'numeric' => array(
				'rule' => array('numeric'),
				'message' => 'Width can contains only numeric characters.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
		...
		'height' => array(
			'numeric' => array(
				'rule' => array('numeric'),
				'message' => 'Height can contains only numeric characters.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
		...
		'method' => array(
			'inList' => array(
				'rule' => array('inList', array('Scale', 'Crop')),
				'message' => 'Please provide a valid method value.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
			...
			'notEmpty' => array(
				'rule' => array('notEmpty'),
				'message' => 'Method value can not be empty.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
