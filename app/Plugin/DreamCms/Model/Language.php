	...
	public $validate = array(
		'name' => array(
			...
			'maxLength' => array(
				...
				'message' => 'Language name can not be exceeded 32 characters.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
			...
			'notEmpty' => array(
				'rule' => array('notEmpty'),
				'message' => 'Language name can not be empty.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
		...
		'locale' => array(
			'minLength' => array(
				...
				'message' => 'Locale has to be at least 5 characters.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
			...
			'maxLength' => array(
				...
				'message' => 'Locale can not be exceeded 10 characters.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
