...
<?php $this->startIfEmpty('breadcrumb'); ?>
						<ul class="breadcrumb">
							...
							<li class="active"><?php echo __('Photos'); ?></li>
						</ul><!-- .breadcrumb -->
<?php $this->end(); ?>

<div class="row">
	<div class="col-sm-12">
		<h2><?php echo __('Photo Trace Log') . ': #' . $data['CmsLog']['id']; ?></h2>
									...
									<fieldset>
										...
										<div class="form-group">
											<div class="input select">
												<?php 
													$current = isset($this->request->data['PhotoBefore']['photo_album_id']) ? $this->request->data['PhotoBefore']['photo_album_id'] : null;
								...
								<?php echo $this->Form->create('PhotoAfter', array('role' => 'form', 'enctype' => 'multipart/form-data', 'url' => '#')); ?> 
									<fieldset>
										...
										<div class="form-group">
											<div class="input select">
												<?php 
													$current = isset($this->request->data['PhotoAfter']['photo_album_id']) ? $this->request->data['PhotoAfter']['photo_album_id'] : null;
													echo $this->DreamcmsForm->treeSelect(array(
														'model' => 'Photo',
														'field' => 'photo_album_id',
														'class' => 'form-control',
